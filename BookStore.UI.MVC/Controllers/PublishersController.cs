...
namespace BookStore.UI.MVC.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PublisherId,PublisherName,Address,City,State,Country,PostalCode,Phone,Email,Website")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PublisherId,PublisherName,Address,City,State,Country,PostalCode,Phone,Email,Website")] Publisher publisher)
        {
